...
Route::get('/transactions/latest', [TransactionController::class, 'sortLatest']);
Route::get('/transactions/oldest', [TransactionController::class, 'sortOldest']);
...
Route::post('/transaction/search', [TransactionController::class, 'searchTransaction']);
